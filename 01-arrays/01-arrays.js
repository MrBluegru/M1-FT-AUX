...
function invertirOrden(array) {
    ...
    for(let i=0; i<array.length; i++){
        ...
        if (array[i] < 10) reverso.unshift(array[i]);
    }
    return reverso;
};
...
function numeroEnComun(array1, array2) {
    ...
    // Infinity; contempla valores infinitos 
    ...
    return Math.min(...array1, ...array2); // busca en ambos arrays el menor valor
};



function sumaDeArrays(array) {
    // El array recibido por parametro es un array multidimencional con array's que contienen 
    // elementos de tipo number
    // Tienen que devolver UN SOLO array que solo contenga elementos de tipo number
    // Sumando los elementos de cada array que contenga dos elementos, y devolviendo la suma del mismo
    // OJO: Si el elemento dentro del array que ingresa por prop, ya es de tipo number, deben devolverlo 
    // como tal dentro del array que retornan.
